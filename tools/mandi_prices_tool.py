...
def get_farmer_mandi_prices(user_id: str = 'default_user'):
...
def get_mandi_prices_for_date(date: str, user_id: str = 'default_user'):
...
def get_commodity_price_info(commodity: str, user_id: str = 'default_user'):
