...
def get_relevant_schemes_for_farmer(user_id: str = 'default_user'):
...
def search_government_schemes(query: str = 'latest agricultural schemes for farmers in India'):
...
def get_scheme_details(scheme_name: str, user_id: str = 'default_user'):
...
def list_all_available_schemes(user_id: str = 'default_user'):
